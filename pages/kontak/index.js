    ...
    <div className="w-100">
      ...
      <div className="d-block">
        ...
        <div className=" d-inline-block  align-top " style={styleContainer}>
          <h4 className="w-50 text mt-2">Kontak</h4>
          <div className="mx-auto w-50 mt-5  p-2 rounded border border-success border-3">
            ...
            <table className="table w-100 ">
              <tr >
                ...
                <td>
                  <p>Puskesmas Rawat Inap Jungkat</p>
                </td>
              </tr>
              <tr >
                <td>
              ...
              <tr >
                ...
                <td>
                  <p>Jl. Raya Jungkat, Sei Nipah, Kec. Jongkat, Kab. Mempawah, Kalimantan Barat 78351</p>
                </td>
              </tr>
              <tr>
                <td>
